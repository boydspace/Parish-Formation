				...
				el( InspectorControls, {},
					el( PanelBody, { title: __( 'Question Settings', 'parish-formation' ), initialOpen: true },
						el( SelectControl, { label: __( 'Question type', 'parish-formation' ), value: attrs.type, options: [
							...
							{ label: __( '— Instructor Reviewed —', 'parish-formation' ), value: '__review', disabled: true }, { label: __( 'Paragraph Response', 'parish-formation' ), value: 'paragraph' }, { label: __( 'File Upload', 'parish-formation' ), value: 'file_upload' },
						...
						], onChange: function ( value ) { if ( value.indexOf( '__' ) === 0 ) { return; } props.setAttributes( { type: value, graded: ! [ 'reflection', 'acknowledgement', 'rating_scale', 'yes_no' ].includes( value ), manualReview: [ 'reflection', 'paragraph', 'file_upload' ].includes( value ) } ); } } ),
